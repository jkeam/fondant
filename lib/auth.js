 ...
 * @param {string} scopes The scope of access with the google document.
 * @param {string} tokenPath The path to the auth token.
...
/**
 * Prompt the user to enter their auth code.
 * 
 * @param {string} prompt The prompt to ask user to enter in the code.
 */
